...
const HeroSection = () => {
  return (
    <div className="w-full  md:py-[120px] relative">
      <div className="max-w-[1207px]  lg:flex justify-between  mx-auto  max-lg:p-10">
        <div className=" w-fit h-fit space-y-10  ">
          ...
          <p className="w-fit  text-[18px] leading-[27px] text-neutral-600">Learn foreign languages effortlessly with expert guidance in your native Myanmar language. Start your journey today!</p>
          <button className="w-[137px]  rounded-[4px] px-[8px] py-[12px] bg-primary-color text-neutral mt-10 ">Apply Now</button>
        </div>
